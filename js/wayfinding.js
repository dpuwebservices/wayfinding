...
info_map = {
	...
	"2_studios": ["<strong>DIGI Lab and Media Studios</strong><br /><br /><strong>DIGI Lab</strong><br />The DIGI Lab&rsquo;s focus is to work with faculty to create games and simulations for their classes, but also to provide overarching teaching and learning around game-based learning, gamification, and extended reality (XR).<br /><br /><strong>Media Studios</strong><br />All include MacPros with single or double screens conducive to video and sound editing. Microphones, cameras, keyboards, analog media players and other hardware can be attached to workstations to serve different purposes such as sound or video recording, presentation practice, podcasting, digitization, and digital preservation.<br /><br /><strong>Studio G (Green Screen or Photography Studio)</strong><br />Production space with professional, pre-set light system and green screen. <br /> <br /><strong>Instructions:</strong><br />To reserve a media studio: scan below, go to <strong>libcal.depaul.edu</strong>, or talk to a library staff member for assistance.<br /><br /> <img src=\"../images/group-study-qr-code.png\" width=\"150\" height=\"150\">", ["2_studios.png"]],
