	...
	info_map={
		...
		"groupstudyzones": 		["<p><strong>Collaborative Areas </strong></p> <p>Talking and group work are permitted on on the first and second floors. The third and fourth floors are for quiet study, wieh the following exceptions:</p> <ul> <li>Group study rooms</li> <li>The section of the third floor designated as a \"Zoom-friendly\" area.</li> </ul>", ["1_groupstudyzone.png", "2_groupstudyzone.png"]],
		...
		"3_zoom": 		["<p><strong>Online Class Zone</strong></p><p>The study carrels in this section of the third floor are consindered \"Zoom-Friendly.\" Students may attend online classes here using headsets (available for checkout from Access Services).</p><p>Speaking at a low volume is allowed in this zone. The rest of the third floor remains a quiet-study zone.</p>", ["3_zoom.png"]],
